...
InterfaceType::InterfaceType(ActorType actorType,
...
bool InterfaceType::operator==(const InterfaceType& other) const
{
    return mActorType == other.mActorType &&
           mLocalInterfaceId == other.mLocalInterfaceId;
}

std::ostream& operator<<(std::ostream& os, const InterfaceType& interfaceType)
{
    os << interfaceType.mActorType
       << (char)(interfaceType.mLocalInterfaceId + 48);
    return os;
}
