...
Probability::Probability(
    ...
    , mModelProbabilityDistribution(probabilityDensityFunction)
{
}
...
void Probability::removeAssignment(ResourceInstance& assignmentToRemove)
{
    ...
    if(it == mAssignments.end())
    {
        throw std::runtime_error(
            "moreorg::metrics::Probability::removeAssignment could not find "
            "assignment and remove it.");
    } else
    {
...
ProbabilityDensityFunction::Ptr
Probability::getProbabilityDensityFunction() const
{
