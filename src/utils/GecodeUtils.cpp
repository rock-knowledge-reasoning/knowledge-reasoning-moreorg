...
std::map<Gecode::IntValBranch::Select, std::string>
    GecodeUtils::IntValSelect2Txt = {
...
std::map<Gecode::IntVarBranch::Select, std::string>
    GecodeUtils::IntVarSelect2Txt = {
...
GecodeUtils::getIntValSelect(const std::string& txt)
{
    ...
    throw std::invalid_argument("moreorg::utils::GecodeUtils::getIntValSelect: "
...
GecodeUtils::getIntVarSelect(const std::string& txt)
{
    ...
    throw std::invalid_argument("moreorg::utils::GecodeUtils::getIntVarSelect: "
                                "could not find value for '" +
                                txt + "'");
}
