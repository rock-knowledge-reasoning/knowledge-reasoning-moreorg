...
public:
    ...
    /**
     * Compute the metric for a given function (service) and a single agent
     * model \return computed metric
     */
    double compute(const owlapi::model::IRI& function,
     ...
     */
    double computeExclusiveUse(const ModelPool& required,
     ...
     * \return metric
     */
    double computeExclusiveUse(const owlapi::model::IRISet& functions,
                               const ResourceInstance::List& modelPool) const;
     ...
     */
    double computeSharedUse(const ModelPool& required,
     ...
     * \return metric
     */
    double computeSharedUse(const owlapi::model::IRISet& functions,
                            const ResourceInstance::List& modelPool) const;
        ...
        double t1 = 0) const
    {
        throw std::runtime_error(
            "moreorg::metrics::Metric::compute: not implemented");
    }

    /**
     * Get list of Metrics to be able to check whether the corresponding
     * component(s) survive or not or handle metric value calculations elsewhere
     */

    virtual Metric::List getSharedUseMetricModelsList(
        const std::vector<owlapi::model::OWLCardinalityRestriction::Ptr>&
            required,
    ...
    /**
     * Compute the metric for a given list of single functions (services) that
     * are used sequentially and a model pool describing a composite actor that
     * has to provide this functions
     */
    virtual double computeSequential(const owlapi::model::IRIList& functions,
                                     const ModelPool& modelPool) const
    {
        throw std::runtime_error("moreorg::metrics::Metric::computeSequential("
                                 "IRIList,ModelPool) not implemented");
    }
     ...
     */
    virtual double computeSequential(
        const std::vector<owlapi::model::IRISet>& functionalRequirement,
        const ModelPool& modelPool,
        bool sharedUse = true) const
    {
        throw std::runtime_error("moreorg::metrics::Metric::compute(functions,"
                                 "modelPool) not implemented");
    }
     ...
     */
    virtual double sequentialUse(const std::vector<double>& values) const
    {
        throw std::runtime_error(
            "moreorg::metrics::Metric::sequentialUse  not implemented");
    }
